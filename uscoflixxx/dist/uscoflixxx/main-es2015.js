...
let EditarComponent = class EditarComponent {
    constructor(supermercadoService, tipoService, ofertaService, activatedRoute, router) {
...
let ListarOfertaComponent = class ListarOfertaComponent {
    constructor(ofertaService, tokenService, router) {
        this.ofertaService = ofertaService;
...
ListarOfertaComponent.ctorParameters = () => [
...
let NuevoComponent = class NuevoComponent {
    constructor(tipoService, supermercadoService, ofertasService, router) {
        this.tipoService = tipoService;
        this.supermercadoService = supermercadoService;
...
let AddComponent = class AddComponent {
    ...
    onRegister() {
        ...
        this.authService.registro(this.usuario).subscribe(data => {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Nuevo cliente', `Cliente ${this.usuario.nombre} creado con exito`, 'success');
        }, (err) => {
            this.mensajeFail = err.error.mensaje;
            this.isRegister = false;
...
let AuthenticationService = class AuthenticationService {
    ...
    authenticate(username, password) {
        ...
        return this.httpClient.get('http://localhost:8080/uscoflixxx-1/usuarios/validateLogin', { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(userData => {
...
const interceptorProvider = [{ provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: BasicAuthHtppInterceptorService, multi: true }];
...
let ServiceService = class ServiceService {
    ...
    createPersonas(usuario) {
        return this.http.post(this.Url, usuario);
    }
    getPersonaId(id) {
        return this.http.get(this.Url + '/' + id);
    }
    updatePersona(usuario) {
        return this.http.put(this.Url + '/' + usuario.id, usuario);
    }
    deletePersona(usuario) {
...
const cabecera = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': ' application/json' }) };
let SupermercadoService = class SupermercadoService {
    constructor(httpClient) {
        this.httpClient = httpClient;
        this.productoURL = 'http://localhost:8080/uscoflixxx-1/ofertas/';
    }
...
SupermercadoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
TipoOfertasService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let SupermercadosComponent = class SupermercadosComponent {
    constructor(supermercadoService, tokenService, router) {
        this.supermercadoService = supermercadoService;
        this.tokenService = tokenService;
        this.router = router;
        this.info = {};
...
SupermercadosComponent.ctorParameters = () => [
